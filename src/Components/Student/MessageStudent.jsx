...
const MessageStudent = ({category, mainindex, individualEmail }) => {
  ...
  return (
    <>
        <div className='w-full md:w-6/12 block mx-auto'>
            ...
            <button onClick={messageStudent} className='w-full my-2 p-2 rounded-md text-center bg-blue-600 hover:bg-blue-500'>Send To Joshua</button>
        </div>
    </>
  )
}
