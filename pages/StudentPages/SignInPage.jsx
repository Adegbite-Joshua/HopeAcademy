            ...
            <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-8 h-screen px-4 bg-gray-200">
                <div className='bg-white p-8 rounded-lg'>
                    <form onSubmit={formik.handleSubmit} className="flex flex-col gap-4">
                        ...
                        <input className='form-input p-2 my-2 border-2 rounded-md' {...formik.getFieldProps('matricNumber')} id='matricNumber' name='matricNumber' type="text" placeholder='Matric Number' />
